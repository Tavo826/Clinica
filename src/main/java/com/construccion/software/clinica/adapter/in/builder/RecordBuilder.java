...
import com.construccion.software.clinica.adapter.in.validators.RecordValidator;
...
public class RecordBuilder {
    ...
    public MedicalRecord build(RecordRequest request) throws Exception {
        ...
        medicalRecord.setDocumentId(recordValidator.documentValidator(request.getDocumentId()));
        medicalRecord.setClinicalRecords(clinicalRecords);
